...
__all__ = ["corr", "partial_corr", "mantel_partial_corr","pcorr", "rcorr", "rm_corr",
           "distance_corr"]
...
@pf.register_dataframe_method
def mantel_partial_corr(data=None, x=None, y=None, covar=None, x_covar=None,
                 y_covar=None, tail='two-sided', method='pearson', permutations = 10000):
    """Partial and semi-partial correlation.
